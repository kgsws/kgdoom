...
#define VDOORWAIT_SINGLE	-1

#define VDOORSPEED_GENERIC	((FRACUNIT*2)/16)
#define VDOORSPEED_THRSH	(((FRACUNIT*2)/16)*56) // blazing sound threshold

void EV_GenericDoor(sector_t *sec, int tag, int lightag, int speed, int wait, int dir);
