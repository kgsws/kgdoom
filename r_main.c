...
{	
    ...
    return 0;
//	return (int)( atan2( (float)y / 0.000015259f, (float)x / 0.000015259f ) * 683563676.788897377f);
}
...
{
    static fixed_t render_pitch = 0x7FFF << FRACBITS;
    fixed_t     pitch;
    int		i;
    fixed_t	dy;
    ...
    if(render_pitch != pitch)
    {
	render_pitch = pitch;
	centery = viewheight/2 + pitch;
